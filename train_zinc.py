...
def main():
    ...
    # 1. split into train/test, we use test set to check reconstruction error
    # and the % of samples from prior p(z) that are valid
    # XTE = data[0:5000]
    XTR = data[5000:]
    ...
    model_save = 'results/zinc_vae_grammar_L' + str(args.latent_dim) + '_E' + \
                 str(args.epochs) + '_val.hdf5'
    print(model_save)
    model = MoleculeVAE()
    ...
    if os.path.isfile(args.load_model):
        ...
        model.create(rules, max_length=MAX_LEN,
