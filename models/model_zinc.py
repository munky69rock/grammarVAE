...
class MoleculeVAE():
    ...
    def _buildEncoder(self, x, latent_rep_size, max_length, epsilon_std=0.01):
        ...
        # essentially we mask the training data so that
        # we are only allowed to apply future rules
        # based on the current non-terminal
        ...
        def vae_loss(x, x_decoded_mean):
            # we add this new function to the loss
    ...
    def load(self, charset, weights_file, latent_rep_size=2,
             max_length=MAX_LEN):
